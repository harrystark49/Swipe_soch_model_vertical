...
//        setOverScrollMode(OVER_SCROLL_NEVER);
        ...
        try {
            ...
            minHeightWidthRatioField.setFloat(this, minHeightWidthRatioField.getFloat(this) * 4);
        } catch (NoSuchFieldException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        ...
        try {
            ...
            minHeightWidthRatioField.setAccessible(true);
            minHeightWidthRatioField.setInt(this, minHeightWidthRatioField.getInt(this) * 8);
        } catch (NoSuchFieldException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
